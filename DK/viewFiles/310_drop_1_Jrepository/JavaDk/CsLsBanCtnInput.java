...
public class CsLsBanCtnInput extends ServiceInput {
	...
	public CsLsBanCtnInput() throws EnvironmentException, FMLManipulationException {
		...
		this.fmlBuffer[17] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[17], 17, 1);
		this.fmlBuffer[18] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[18], 18, 1);
		this.fmlBuffer[19] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, defaultValues[19], 19, 1);
		this.fmlBuffer[20] = new FmlField("DEPARTMENT_CODE", FmlField.TYPE_STRING, 5, defaultValues[20], 20, 1);
		this.fmlBuffer[21] = new FmlField("PAGE", FmlField.TYPE_INTEGER, -1, defaultValues[21], 21, 1);
		this.fmlBuffer[22] = new FmlField("PAGESIZE", FmlField.TYPE_INTEGER, -1, defaultValues[22], 22, 1);
		this.fmlBuffer[23] = new FmlField("SPECIFICCTN", FmlField.TYPE_STRING, 21, defaultValues[23], 23, 1);
	} // End of constractor
