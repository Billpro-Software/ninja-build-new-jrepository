...
public class ArLsDefAgrOutput extends ServiceOutput {
	...
	private void createFmlBuffer() throws FMLManipulationException {
		...
		this.fmlBuffer[54] = new FmlField("PRMT_ROWID", FmlField.TYPE_STRING, 19, null, 54, 600);
		this.fmlBuffer[55] = new FmlField("PT_DURATION", FmlField.TYPE_SHORT, -1, null, 55, 600);
		this.fmlBuffer[56] = new FmlField("DURATION_IND", FmlField.TYPE_BYTE, -1, null, 56, 600);
		this.fmlBuffer[57] = new FmlField("PP_IND", FmlField.TYPE_BYTE, -1, null, 57, 600);
		this.fmlBuffer[58] = new FmlField("AUTO_RENEWAL_IND", FmlField.TYPE_BYTE, -1, null, 58, 600);
		this.fmlBuffer[59] = new FmlField("CUT_DATE", FmlField.TYPE_STRING, 9, null, 59, 600);
		this.fmlBuffer[60] = new FmlField("TRS_ROWID", FmlField.TYPE_STRING, 19, null, 60, 600);
		this.fmlBuffer[61] = new FmlField("TRS_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 61, 600);
		this.fmlBuffer[62] = new FmlField("TRS_SOC", FmlField.TYPE_STRING, 10, null, 62, 600);
		this.fmlBuffer[63] = new FmlField("CALL_TYPE_CODE", FmlField.TYPE_BYTE, -1, null, 63, 600);
		this.fmlBuffer[64] = new FmlField("TOLL_RS_DESC", FmlField.TYPE_STRING, 31, null, 64, 600);
		this.fmlBuffer[65] = new FmlField("SUBLN_ROWID", FmlField.TYPE_STRING, 19, null, 65, 600);
		this.fmlBuffer[66] = new FmlField("FULL_AMT", FmlField.TYPE_DOUBLE, -1, null, 66, 600);
		this.fmlBuffer[67] = new FmlField("FIRST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 67, 600);
		this.fmlBuffer[68] = new FmlField("OTHER_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 68, 600);
		this.fmlBuffer[69] = new FmlField("LAST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 69, 600);
		this.fmlBuffer[70] = new FmlField("NO_OF_INSTALLMENTS", FmlField.TYPE_SHORT, -1, null, 70, 600);
		this.fmlBuffer[71] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 71, 600);
		this.fmlBuffer[72] = new FmlField("DCI_ERROR_CODE", FmlField.TYPE_INTEGER, -1, null, 72, 1);
		this.fmlBuffer[73] = new FmlField("DCI_ERROR_TYPE", FmlField.TYPE_SHORT, -1, null, 73, 1);
		this.fmlBuffer[74] = new FmlField("DCI_ERROR_TEXT", FmlField.TYPE_STRING, 81, null, 74, 1);
		this.fmlBuffer[75] = new FmlField("DCI_ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 75, 1);
		this.fmlBuffer[76] = new FmlField("DCI_MORE_ROWS", FmlField.TYPE_SHORT, -1, null, 76, 1);
	} // End of constractor
	...
	public String get_PRMT_ROWID(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[54].getValue(nIndex)); }
	public void set_PRMT_ROWID(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[54].setValue(nIndex, value); }
	public int get_PRMT_ROWID_size() throws FMLManipulationException { return (this.fmlBuffer[54].getCount()); }


	public Integer get_PT_DURATION(int nIndex) throws FMLManipulationException { return (TypeConverter.shortToInteger((Short) this.fmlBuffer[55].getValue(nIndex))); }
	public void set_PT_DURATION(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[55].setValue(nIndex, TypeConverter.integerToShort(value)); }
	public int get_PT_DURATION_size() throws FMLManipulationException { return (this.fmlBuffer[55].getCount()); }


	public String get_DURATION_IND(int nIndex) throws FMLManipulationException { return (TypeConverter.byteToString((Byte) this.fmlBuffer[56].getValue(nIndex))); }
	public void set_DURATION_IND(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[56].setValue(nIndex, TypeConverter.stringToByte(value)); }
	public int get_DURATION_IND_size() throws FMLManipulationException { return (this.fmlBuffer[56].getCount()); }


	public String get_PP_IND(int nIndex) throws FMLManipulationException { return (TypeConverter.byteToString((Byte) this.fmlBuffer[57].getValue(nIndex))); }
	public void set_PP_IND(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[57].setValue(nIndex, TypeConverter.stringToByte(value)); }
	public int get_PP_IND_size() throws FMLManipulationException { return (this.fmlBuffer[57].getCount()); }


	public String get_AUTO_RENEWAL_IND(int nIndex) throws FMLManipulationException { return (TypeConverter.byteToString((Byte) this.fmlBuffer[58].getValue(nIndex))); }
	public void set_AUTO_RENEWAL_IND(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[58].setValue(nIndex, TypeConverter.stringToByte(value)); }
	public int get_AUTO_RENEWAL_IND_size() throws FMLManipulationException { return (this.fmlBuffer[58].getCount()); }


	public String get_CUT_DATE(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[59].getValue(nIndex)); }
	public void set_CUT_DATE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[59].setValue(nIndex, value); }
	public int get_CUT_DATE_size() throws FMLManipulationException { return (this.fmlBuffer[59].getCount()); }


	public String get_TRS_ROWID(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[60].getValue(nIndex)); }
	public void set_TRS_ROWID(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[60].setValue(nIndex, value); }
	public int get_TRS_ROWID_size() throws FMLManipulationException { return (this.fmlBuffer[60].getCount()); }


	public String get_TRS_EXPIRATION_DATE(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[61].getValue(nIndex)); }
	public void set_TRS_EXPIRATION_DATE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[61].setValue(nIndex, value); }
	public int get_TRS_EXPIRATION_DATE_size() throws FMLManipulationException { return (this.fmlBuffer[61].getCount()); }


	public String get_TRS_SOC(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[62].getValue(nIndex)); }
	public void set_TRS_SOC(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[62].setValue(nIndex, value); }
	public int get_TRS_SOC_size() throws FMLManipulationException { return (this.fmlBuffer[62].getCount()); }


	public String get_CALL_TYPE_CODE(int nIndex) throws FMLManipulationException { return (TypeConverter.byteToString((Byte) this.fmlBuffer[63].getValue(nIndex))); }
	public void set_CALL_TYPE_CODE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[63].setValue(nIndex, TypeConverter.stringToByte(value)); }
	public int get_CALL_TYPE_CODE_size() throws FMLManipulationException { return (this.fmlBuffer[63].getCount()); }


	public String get_TOLL_RS_DESC(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[64].getValue(nIndex)); }
	public void set_TOLL_RS_DESC(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[64].setValue(nIndex, value); }
	public int get_TOLL_RS_DESC_size() throws FMLManipulationException { return (this.fmlBuffer[64].getCount()); }


	public String get_SUBLN_ROWID(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[65].getValue(nIndex)); }
	public void set_SUBLN_ROWID(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[65].setValue(nIndex, value); }
	public int get_SUBLN_ROWID_size() throws FMLManipulationException { return (this.fmlBuffer[65].getCount()); }


	public Double get_FULL_AMT(int nIndex) throws FMLManipulationException { return ((Double) this.fmlBuffer[66].getValue(nIndex)); }
	public void set_FULL_AMT(int nIndex, Double value) throws FMLManipulationException { this.fmlBuffer[66].setValue(nIndex, value); }
	public int get_FULL_AMT_size() throws FMLManipulationException { return (this.fmlBuffer[66].getCount()); }


	public Double get_FIRST_INSTALL_RATE(int nIndex) throws FMLManipulationException { return ((Double) this.fmlBuffer[67].getValue(nIndex)); }
	public void set_FIRST_INSTALL_RATE(int nIndex, Double value) throws FMLManipulationException { this.fmlBuffer[67].setValue(nIndex, value); }
	public int get_FIRST_INSTALL_RATE_size() throws FMLManipulationException { return (this.fmlBuffer[67].getCount()); }


	public Double get_OTHER_INSTALL_RATE(int nIndex) throws FMLManipulationException { return ((Double) this.fmlBuffer[68].getValue(nIndex)); }
	public void set_OTHER_INSTALL_RATE(int nIndex, Double value) throws FMLManipulationException { this.fmlBuffer[68].setValue(nIndex, value); }
	public int get_OTHER_INSTALL_RATE_size() throws FMLManipulationException { return (this.fmlBuffer[68].getCount()); }


	public Double get_LAST_INSTALL_RATE(int nIndex) throws FMLManipulationException { return ((Double) this.fmlBuffer[69].getValue(nIndex)); }
	public void set_LAST_INSTALL_RATE(int nIndex, Double value) throws FMLManipulationException { this.fmlBuffer[69].setValue(nIndex, value); }
	public int get_LAST_INSTALL_RATE_size() throws FMLManipulationException { return (this.fmlBuffer[69].getCount()); }


	public Integer get_NO_OF_INSTALLMENTS(int nIndex) throws FMLManipulationException { return (TypeConverter.shortToInteger((Short) this.fmlBuffer[70].getValue(nIndex))); }
	public void set_NO_OF_INSTALLMENTS(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[70].setValue(nIndex, TypeConverter.integerToShort(value)); }
	public int get_NO_OF_INSTALLMENTS_size() throws FMLManipulationException { return (this.fmlBuffer[70].getCount()); }


	public Integer get_SUBSCRIBER_ID(int nIndex) throws FMLManipulationException { return ((Integer) this.fmlBuffer[71].getValue(nIndex)); }
	public void set_SUBSCRIBER_ID(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[71].setValue(nIndex, value); }
	public int get_SUBSCRIBER_ID_size() throws FMLManipulationException { return (this.fmlBuffer[71].getCount()); }


	public Integer get_DCI_ERROR_CODE() throws FMLManipulationException { return ((Integer) this.fmlBuffer[72].getValue(0)); }
	public void set_DCI_ERROR_CODE(Integer value) throws FMLManipulationException { this.fmlBuffer[72].setValue(0, value); }


	public Integer get_DCI_ERROR_TYPE() throws FMLManipulationException { return (TypeConverter.shortToInteger((Short) this.fmlBuffer[73].getValue(0))); }
	public void set_DCI_ERROR_TYPE(Integer value) throws FMLManipulationException { this.fmlBuffer[73].setValue(0, TypeConverter.integerToShort(value)); }


	public String get_DCI_ERROR_TEXT() throws FMLManipulationException { return ((String) this.fmlBuffer[74].getValue(0)); }
	public void set_DCI_ERROR_TEXT(String value) throws FMLManipulationException { this.fmlBuffer[74].setValue(0, value); }


	public Integer get_DCI_ROW_COUNT() throws FMLManipulationException { return ((Integer) this.fmlBuffer[75].getValue(0)); }
	public void set_DCI_ROW_COUNT(Integer value) throws FMLManipulationException { this.fmlBuffer[75].setValue(0, value); }


	public Integer get_DCI_MORE_ROWS() throws FMLManipulationException { return (TypeConverter.shortToInteger((Short) this.fmlBuffer[76].getValue(0))); }
	public void set_DCI_MORE_ROWS(Integer value) throws FMLManipulationException { this.fmlBuffer[76].setValue(0, TypeConverter.integerToShort(value)); }
