...
public class CsInsOrdInput extends ServiceInput {
	...
	public CsInsOrdInput() throws EnvironmentException, FMLManipulationException {
		...
		this.fmlBuffer[36] = new FmlField("ORD_REFERENCE_ID", FmlField.TYPE_STRING, 51, defaultValues[36], 36, 1);
		this.fmlBuffer[37] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[37], 37, 1);
		this.fmlBuffer[38] = new FmlField("ORDADDINROWID", FmlField.TYPE_STRING, 19, defaultValues[38], 38, 600);
		this.fmlBuffer[39] = new FmlField("ORDADDINORDER_NUMBER", FmlField.TYPE_INTEGER, -1, defaultValues[39], 39, 600);
		this.fmlBuffer[40] = new FmlField("FIELD_NAME", FmlField.TYPE_STRING, 31, defaultValues[40], 40, 600);
		this.fmlBuffer[41] = new FmlField("ORDADDINSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[41], 41, 600);
		this.fmlBuffer[42] = new FmlField("ORDADDINSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[42], 42, 600);
		this.fmlBuffer[43] = new FmlField("ORDADDINOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[43], 43, 600);
		this.fmlBuffer[44] = new FmlField("ORDADDINAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[44], 44, 600);
		this.fmlBuffer[45] = new FmlField("ORDADDINDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[45], 45, 600);
		this.fmlBuffer[46] = new FmlField("ORDADDINDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[46], 46, 600);
		this.fmlBuffer[47] = new FmlField("FIELD_VALUE", FmlField.TYPE_STRING, 256, defaultValues[47], 47, 600);
		this.fmlBuffer[48] = new FmlField("PORDDTLSBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[48], 48, 1);
		this.fmlBuffer[49] = new FmlField("ORDDTLSROWID", FmlField.TYPE_STRING, 19, defaultValues[49], 49, 600);
		this.fmlBuffer[50] = new FmlField("ORDDTLSORDER_NUMBER", FmlField.TYPE_INTEGER, -1, defaultValues[50], 50, 600);
		this.fmlBuffer[51] = new FmlField("ORDER_LINE_NO", FmlField.TYPE_INTEGER, -1, defaultValues[51], 51, 600);
		this.fmlBuffer[52] = new FmlField("ORDDTLSSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[52], 52, 600);
		this.fmlBuffer[53] = new FmlField("ORDDTLSSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[53], 53, 600);
		this.fmlBuffer[54] = new FmlField("ORDDTLSOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[54], 54, 600);
		this.fmlBuffer[55] = new FmlField("ORDDTLSAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[55], 55, 600);
		this.fmlBuffer[56] = new FmlField("ORDDTLSDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[56], 56, 600);
		this.fmlBuffer[57] = new FmlField("ORDDTLSDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[57], 57, 600);
		this.fmlBuffer[58] = new FmlField("EXT_TRX_ID", FmlField.TYPE_STRING, 41, defaultValues[58], 58, 600);
		this.fmlBuffer[59] = new FmlField("EXT_LINKED_TRX_ID", FmlField.TYPE_STRING, 41, defaultValues[59], 59, 600);
		this.fmlBuffer[60] = new FmlField("EXT_PRODUCT_ID", FmlField.TYPE_STRING, 41, defaultValues[60], 60, 600);
		this.fmlBuffer[61] = new FmlField("EXT_COST_AMOUNT", FmlField.TYPE_DOUBLE, -1, defaultValues[61], 61, 600);
		this.fmlBuffer[62] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, defaultValues[62], 62, 600);
		this.fmlBuffer[63] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, defaultValues[63], 63, 600);
		this.fmlBuffer[64] = new FmlField("ADJ_REASON_CODE", FmlField.TYPE_STRING, 7, defaultValues[64], 64, 600);
		this.fmlBuffer[65] = new FmlField("AMOUNT", FmlField.TYPE_DOUBLE, -1, defaultValues[65], 65, 600);
		this.fmlBuffer[66] = new FmlField("BILL_COMMENT", FmlField.TYPE_STRING, 501, defaultValues[66], 66, 600);
		this.fmlBuffer[67] = new FmlField("ENT_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[67], 67, 600);
		this.fmlBuffer[68] = new FmlField("QUANTITY", FmlField.TYPE_INTEGER, -1, defaultValues[68], 68, 600);
		this.fmlBuffer[69] = new FmlField("CHARGE_CREATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[69], 69, 600);
		this.fmlBuffer[70] = new FmlField("PORDLNADDINBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[70], 70, 1);
		this.fmlBuffer[71] = new FmlField("ORDLNADDINROWID", FmlField.TYPE_STRING, 19, defaultValues[71], 71, 600);
		this.fmlBuffer[72] = new FmlField("ORDLNADDINORDER_NUMBER", FmlField.TYPE_INTEGER, -1, defaultValues[72], 72, 600);
		this.fmlBuffer[73] = new FmlField("ORDLNADDINORDER_LINE_NO", FmlField.TYPE_INTEGER, -1, defaultValues[73], 73, 600);
		this.fmlBuffer[74] = new FmlField("ORDLNADDINFIELD_NAME", FmlField.TYPE_STRING, 31, defaultValues[74], 74, 600);
		this.fmlBuffer[75] = new FmlField("ORDLNADDINSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[75], 75, 600);
		this.fmlBuffer[76] = new FmlField("ORDLNADDINSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[76], 76, 600);
		this.fmlBuffer[77] = new FmlField("ORDLNADDINOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[77], 77, 600);
		this.fmlBuffer[78] = new FmlField("ORDLNADDINAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[78], 78, 600);
		this.fmlBuffer[79] = new FmlField("ORDLNADDINDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[79], 79, 600);
		this.fmlBuffer[80] = new FmlField("ORDLNADDINDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[80], 80, 600);
		this.fmlBuffer[81] = new FmlField("ORDLNADDINFIELD_VALUE", FmlField.TYPE_STRING, 256, defaultValues[81], 81, 600);
		this.fmlBuffer[82] = new FmlField("PORDPYMLISTROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[82], 82, 1);
		this.fmlBuffer[83] = new FmlField("ORDPYMLISTROWID", FmlField.TYPE_STRING, 19, defaultValues[83], 83, 50);
		this.fmlBuffer[84] = new FmlField("ORDPYMLISTBAN", FmlField.TYPE_INTEGER, -1, defaultValues[84], 84, 50);
		this.fmlBuffer[85] = new FmlField("PAYMENT_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[85], 85, 50);
		this.fmlBuffer[86] = new FmlField("ORDPYMLISTSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[86], 86, 50);
		this.fmlBuffer[87] = new FmlField("ORDPYMLISTSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[87], 87, 50);
		this.fmlBuffer[88] = new FmlField("ORDPYMLISTOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[88], 88, 50);
		this.fmlBuffer[89] = new FmlField("ORDPYMLISTAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[89], 89, 50);
		this.fmlBuffer[90] = new FmlField("ORDPYMLISTDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[90], 90, 50);
		this.fmlBuffer[91] = new FmlField("ORDPYMLISTDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[91], 91, 50);
		this.fmlBuffer[92] = new FmlField("PAYMENT_AMOUNT", FmlField.TYPE_DOUBLE, -1, defaultValues[92], 92, 50);
		this.fmlBuffer[93] = new FmlField("PAYMENT_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[93], 93, 50);
		this.fmlBuffer[94] = new FmlField("ORDPYMLISTEXTERNAL_ORDER_ID", FmlField.TYPE_STRING, 41, defaultValues[94], 94, 50);
		this.fmlBuffer[95] = new FmlField("PAYMENT_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[95], 95, 50);
		this.fmlBuffer[96] = new FmlField("PAYMENT_STATUS_DATE", FmlField.TYPE_STRING, 15, defaultValues[96], 96, 50);
		this.fmlBuffer[97] = new FmlField("AR_PYM_ENT_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[97], 97, 50);
		this.fmlBuffer[98] = new FmlField("PAYMENT_METHOD", FmlField.TYPE_STRING, 3, defaultValues[98], 98, 50);
		this.fmlBuffer[99] = new FmlField("PAYMENT_SUB_METHOD", FmlField.TYPE_STRING, 3, defaultValues[99], 99, 50);
		this.fmlBuffer[100] = new FmlField("SOURCE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[100], 100, 50);
		this.fmlBuffer[101] = new FmlField("SOURCE_ID", FmlField.TYPE_STRING, 9, defaultValues[101], 101, 50);
		this.fmlBuffer[102] = new FmlField("REFERENCE_ID", FmlField.TYPE_STRING, 41, defaultValues[102], 102, 50);
	} // End of constractor
	...
	public Integer get_PORDLNADDINBUFROWCOUNT() throws FMLManipulationException { return ((Integer) this.fmlBuffer[70].getValue(0)); }
	public void set_PORDLNADDINBUFROWCOUNT(Integer value) throws FMLManipulationException { this.fmlBuffer[70].setValue(0, value); }


	public String get_ORDLNADDINROWID(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[71].getValue(nIndex)); }
	public void set_ORDLNADDINROWID(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[71].setValue(nIndex, value); }
	public int get_ORDLNADDINROWID_size() throws FMLManipulationException { return (this.fmlBuffer[71].getCount()); }


	public Integer get_ORDLNADDINORDER_NUMBER(int nIndex) throws FMLManipulationException { return ((Integer) this.fmlBuffer[72].getValue(nIndex)); }
	public void set_ORDLNADDINORDER_NUMBER(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[72].setValue(nIndex, value); }
	public int get_ORDLNADDINORDER_NUMBER_size() throws FMLManipulationException { return (this.fmlBuffer[72].getCount()); }


	public Integer get_ORDLNADDINORDER_LINE_NO(int nIndex) throws FMLManipulationException { return ((Integer) this.fmlBuffer[73].getValue(nIndex)); }
	public void set_ORDLNADDINORDER_LINE_NO(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[73].setValue(nIndex, value); }
	public int get_ORDLNADDINORDER_LINE_NO_size() throws FMLManipulationException { return (this.fmlBuffer[73].getCount()); }


	public String get_ORDLNADDINFIELD_NAME(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[74].getValue(nIndex)); }
	public void set_ORDLNADDINFIELD_NAME(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[74].setValue(nIndex, value); }
	public int get_ORDLNADDINFIELD_NAME_size() throws FMLManipulationException { return (this.fmlBuffer[74].getCount()); }


	public String get_ORDLNADDINSYS_CREATION_DATE(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[75].getValue(nIndex)); }
	public void set_ORDLNADDINSYS_CREATION_DATE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[75].setValue(nIndex, value); }
	public int get_ORDLNADDINSYS_CREATION_DATE_size() throws FMLManipulationException { return (this.fmlBuffer[75].getCount()); }


	public String get_ORDLNADDINSYS_UPDATE_DATE(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[76].getValue(nIndex)); }
	public void set_ORDLNADDINSYS_UPDATE_DATE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[76].setValue(nIndex, value); }
	public int get_ORDLNADDINSYS_UPDATE_DATE_size() throws FMLManipulationException { return (this.fmlBuffer[76].getCount()); }


	public Integer get_ORDLNADDINOPERATOR_ID(int nIndex) throws FMLManipulationException { return ((Integer) this.fmlBuffer[77].getValue(nIndex)); }
	public void set_ORDLNADDINOPERATOR_ID(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[77].setValue(nIndex, value); }
	public int get_ORDLNADDINOPERATOR_ID_size() throws FMLManipulationException { return (this.fmlBuffer[77].getCount()); }


	public String get_ORDLNADDINAPPLICATION_ID(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[78].getValue(nIndex)); }
	public void set_ORDLNADDINAPPLICATION_ID(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[78].setValue(nIndex, value); }
	public int get_ORDLNADDINAPPLICATION_ID_size() throws FMLManipulationException { return (this.fmlBuffer[78].getCount()); }


	public String get_ORDLNADDINDL_SERVICE_CODE(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[79].getValue(nIndex)); }
	public void set_ORDLNADDINDL_SERVICE_CODE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[79].setValue(nIndex, value); }
	public int get_ORDLNADDINDL_SERVICE_CODE_size() throws FMLManipulationException { return (this.fmlBuffer[79].getCount()); }


	public Integer get_ORDLNADDINDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException { return (TypeConverter.shortToInteger((Short) this.fmlBuffer[80].getValue(nIndex))); }
	public void set_ORDLNADDINDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[80].setValue(nIndex, TypeConverter.integerToShort(value)); }
	public int get_ORDLNADDINDL_UPDATE_STAMP_size() throws FMLManipulationException { return (this.fmlBuffer[80].getCount()); }


	public String get_ORDLNADDINFIELD_VALUE(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[81].getValue(nIndex)); }
	public void set_ORDLNADDINFIELD_VALUE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[81].setValue(nIndex, value); }
	public int get_ORDLNADDINFIELD_VALUE_size() throws FMLManipulationException { return (this.fmlBuffer[81].getCount()); }


	public Integer get_PORDPYMLISTROWCOUNT() throws FMLManipulationException { return ((Integer) this.fmlBuffer[82].getValue(0)); }
	public void set_PORDPYMLISTROWCOUNT(Integer value) throws FMLManipulationException { this.fmlBuffer[82].setValue(0, value); }


	public String get_ORDPYMLISTROWID(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[83].getValue(nIndex)); }
	public void set_ORDPYMLISTROWID(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[83].setValue(nIndex, value); }
	public int get_ORDPYMLISTROWID_size() throws FMLManipulationException { return (this.fmlBuffer[83].getCount()); }


	public Integer get_ORDPYMLISTBAN(int nIndex) throws FMLManipulationException { return ((Integer) this.fmlBuffer[84].getValue(nIndex)); }
	public void set_ORDPYMLISTBAN(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[84].setValue(nIndex, value); }
	public int get_ORDPYMLISTBAN_size() throws FMLManipulationException { return (this.fmlBuffer[84].getCount()); }


	public Integer get_PAYMENT_SEQ_NO(int nIndex) throws FMLManipulationException { return ((Integer) this.fmlBuffer[85].getValue(nIndex)); }
	public void set_PAYMENT_SEQ_NO(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[85].setValue(nIndex, value); }
	public int get_PAYMENT_SEQ_NO_size() throws FMLManipulationException { return (this.fmlBuffer[85].getCount()); }


	public String get_ORDPYMLISTSYS_CREATION_DATE(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[86].getValue(nIndex)); }
	public void set_ORDPYMLISTSYS_CREATION_DATE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[86].setValue(nIndex, value); }
	public int get_ORDPYMLISTSYS_CREATION_DATE_size() throws FMLManipulationException { return (this.fmlBuffer[86].getCount()); }


	public String get_ORDPYMLISTSYS_UPDATE_DATE(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[87].getValue(nIndex)); }
	public void set_ORDPYMLISTSYS_UPDATE_DATE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[87].setValue(nIndex, value); }
	public int get_ORDPYMLISTSYS_UPDATE_DATE_size() throws FMLManipulationException { return (this.fmlBuffer[87].getCount()); }


	public Integer get_ORDPYMLISTOPERATOR_ID(int nIndex) throws FMLManipulationException { return ((Integer) this.fmlBuffer[88].getValue(nIndex)); }
	public void set_ORDPYMLISTOPERATOR_ID(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[88].setValue(nIndex, value); }
	public int get_ORDPYMLISTOPERATOR_ID_size() throws FMLManipulationException { return (this.fmlBuffer[88].getCount()); }


	public String get_ORDPYMLISTAPPLICATION_ID(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[89].getValue(nIndex)); }
	public void set_ORDPYMLISTAPPLICATION_ID(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[89].setValue(nIndex, value); }
	public int get_ORDPYMLISTAPPLICATION_ID_size() throws FMLManipulationException { return (this.fmlBuffer[89].getCount()); }


	public String get_ORDPYMLISTDL_SERVICE_CODE(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[90].getValue(nIndex)); }
	public void set_ORDPYMLISTDL_SERVICE_CODE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[90].setValue(nIndex, value); }
	public int get_ORDPYMLISTDL_SERVICE_CODE_size() throws FMLManipulationException { return (this.fmlBuffer[90].getCount()); }


	public Integer get_ORDPYMLISTDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException { return (TypeConverter.shortToInteger((Short) this.fmlBuffer[91].getValue(nIndex))); }
	public void set_ORDPYMLISTDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[91].setValue(nIndex, TypeConverter.integerToShort(value)); }
	public int get_ORDPYMLISTDL_UPDATE_STAMP_size() throws FMLManipulationException { return (this.fmlBuffer[91].getCount()); }


	public Double get_PAYMENT_AMOUNT(int nIndex) throws FMLManipulationException { return ((Double) this.fmlBuffer[92].getValue(nIndex)); }
	public void set_PAYMENT_AMOUNT(int nIndex, Double value) throws FMLManipulationException { this.fmlBuffer[92].setValue(nIndex, value); }
	public int get_PAYMENT_AMOUNT_size() throws FMLManipulationException { return (this.fmlBuffer[92].getCount()); }


	public String get_PAYMENT_CREATION_DATE(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[93].getValue(nIndex)); }
	public void set_PAYMENT_CREATION_DATE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[93].setValue(nIndex, value); }
	public int get_PAYMENT_CREATION_DATE_size() throws FMLManipulationException { return (this.fmlBuffer[93].getCount()); }


	public String get_ORDPYMLISTEXTERNAL_ORDER_ID(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[94].getValue(nIndex)); }
	public void set_ORDPYMLISTEXTERNAL_ORDER_ID(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[94].setValue(nIndex, value); }
	public int get_ORDPYMLISTEXTERNAL_ORDER_ID_size() throws FMLManipulationException { return (this.fmlBuffer[94].getCount()); }


	public String get_PAYMENT_STATUS(int nIndex) throws FMLManipulationException { return (TypeConverter.byteToString((Byte) this.fmlBuffer[95].getValue(nIndex))); }
	public void set_PAYMENT_STATUS(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[95].setValue(nIndex, TypeConverter.stringToByte(value)); }
	public int get_PAYMENT_STATUS_size() throws FMLManipulationException { return (this.fmlBuffer[95].getCount()); }


	public String get_PAYMENT_STATUS_DATE(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[96].getValue(nIndex)); }
	public void set_PAYMENT_STATUS_DATE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[96].setValue(nIndex, value); }
	public int get_PAYMENT_STATUS_DATE_size() throws FMLManipulationException { return (this.fmlBuffer[96].getCount()); }


	public Integer get_AR_PYM_ENT_SEQ_NO(int nIndex) throws FMLManipulationException { return ((Integer) this.fmlBuffer[97].getValue(nIndex)); }
	public void set_AR_PYM_ENT_SEQ_NO(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[97].setValue(nIndex, value); }
	public int get_AR_PYM_ENT_SEQ_NO_size() throws FMLManipulationException { return (this.fmlBuffer[97].getCount()); }


	public String get_PAYMENT_METHOD(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[98].getValue(nIndex)); }
	public void set_PAYMENT_METHOD(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[98].setValue(nIndex, value); }
	public int get_PAYMENT_METHOD_size() throws FMLManipulationException { return (this.fmlBuffer[98].getCount()); }


	public String get_PAYMENT_SUB_METHOD(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[99].getValue(nIndex)); }
	public void set_PAYMENT_SUB_METHOD(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[99].setValue(nIndex, value); }
	public int get_PAYMENT_SUB_METHOD_size() throws FMLManipulationException { return (this.fmlBuffer[99].getCount()); }


	public String get_SOURCE_TYPE(int nIndex) throws FMLManipulationException { return (TypeConverter.byteToString((Byte) this.fmlBuffer[100].getValue(nIndex))); }
	public void set_SOURCE_TYPE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[100].setValue(nIndex, TypeConverter.stringToByte(value)); }
	public int get_SOURCE_TYPE_size() throws FMLManipulationException { return (this.fmlBuffer[100].getCount()); }


	public String get_SOURCE_ID(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[101].getValue(nIndex)); }
	public void set_SOURCE_ID(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[101].setValue(nIndex, value); }
	public int get_SOURCE_ID_size() throws FMLManipulationException { return (this.fmlBuffer[101].getCount()); }


	public String get_REFERENCE_ID(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[102].getValue(nIndex)); }
	public void set_REFERENCE_ID(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[102].setValue(nIndex, value); }
	public int get_REFERENCE_ID_size() throws FMLManipulationException { return (this.fmlBuffer[102].getCount()); }
