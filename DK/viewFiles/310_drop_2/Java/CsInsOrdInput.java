...
public class CsInsOrdInput extends ServiceInput {
	...
	public CsInsOrdInput() throws EnvironmentException, FMLManipulationException {
		...
		this.fmlBuffer[70] = new FmlField("PORDLNADDINBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 70, 1);
		this.fmlBuffer[71] = new FmlField("ORDLNADDINROWID", FmlField.TYPE_STRING, 19, null, 71, 600);
		this.fmlBuffer[72] = new FmlField("ORDLNADDINORDER_NUMBER", FmlField.TYPE_INTEGER, -1, null, 72, 600);
		this.fmlBuffer[73] = new FmlField("ORDLNADDINORDER_LINE_NO", FmlField.TYPE_INTEGER, -1, null, 73, 600);
		this.fmlBuffer[74] = new FmlField("ORDLNADDINFIELD_NAME", FmlField.TYPE_STRING, 31, null, 74, 600);
		this.fmlBuffer[75] = new FmlField("ORDLNADDINSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 75, 600);
		this.fmlBuffer[76] = new FmlField("ORDLNADDINSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 76, 600);
		this.fmlBuffer[77] = new FmlField("ORDLNADDINOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 77, 600);
		this.fmlBuffer[78] = new FmlField("ORDLNADDINAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 78, 600);
		this.fmlBuffer[79] = new FmlField("ORDLNADDINDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 79, 600);
		this.fmlBuffer[80] = new FmlField("ORDLNADDINDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 80, 600);
		this.fmlBuffer[81] = new FmlField("ORDLNADDINFIELD_VALUE", FmlField.TYPE_STRING, 256, null, 81, 600);
		this.fmlBuffer[82] = new FmlField("PORDPYMLISTROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 82, 1);
		this.fmlBuffer[83] = new FmlField("ORDPYMLISTROWID", FmlField.TYPE_STRING, 19, null, 83, 50);
		this.fmlBuffer[84] = new FmlField("ORDPYMLISTBAN", FmlField.TYPE_INTEGER, -1, null, 84, 50);
		this.fmlBuffer[85] = new FmlField("PAYMENT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 85, 50);
		this.fmlBuffer[86] = new FmlField("ORDPYMLISTSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 86, 50);
		this.fmlBuffer[87] = new FmlField("ORDPYMLISTSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 87, 50);
		this.fmlBuffer[88] = new FmlField("ORDPYMLISTOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 88, 50);
		this.fmlBuffer[89] = new FmlField("ORDPYMLISTAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 89, 50);
		this.fmlBuffer[90] = new FmlField("ORDPYMLISTDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 90, 50);
		this.fmlBuffer[91] = new FmlField("ORDPYMLISTDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 91, 50);
		this.fmlBuffer[92] = new FmlField("PAYMENT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 92, 50);
		this.fmlBuffer[93] = new FmlField("PAYMENT_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 93, 50);
		this.fmlBuffer[94] = new FmlField("ORDPYMLISTEXTERNAL_ORDER_ID", FmlField.TYPE_STRING, 41, null, 94, 50);
		this.fmlBuffer[95] = new FmlField("PAYMENT_STATUS", FmlField.TYPE_BYTE, -1, null, 95, 50);
		this.fmlBuffer[96] = new FmlField("PAYMENT_STATUS_DATE", FmlField.TYPE_STRING, 15, null, 96, 50);
		this.fmlBuffer[97] = new FmlField("AR_PYM_ENT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 97, 50);
		this.fmlBuffer[98] = new FmlField("PAYMENT_METHOD", FmlField.TYPE_STRING, 3, null, 98, 50);
		this.fmlBuffer[99] = new FmlField("PAYMENT_SUB_METHOD", FmlField.TYPE_STRING, 3, null, 99, 50);
		this.fmlBuffer[100] = new FmlField("SOURCE_TYPE", FmlField.TYPE_BYTE, -1, null, 100, 50);
		this.fmlBuffer[101] = new FmlField("SOURCE_ID", FmlField.TYPE_STRING, 9, null, 101, 50);
		this.fmlBuffer[102] = new FmlField("REFERENCE_ID", FmlField.TYPE_STRING, 41, null, 102, 50);
	} // End of constractor
