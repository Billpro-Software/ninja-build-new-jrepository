...
public class CsLsSrvAgrOutput extends ServiceOutput {
	...
	private void createFmlBuffer() throws FMLManipulationException {
		...
		this.fmlBuffer[28] = new FmlField("SOC_QUANTITY", FmlField.TYPE_SHORT, -1, SystemDefaultsReferenceTable.getSocQuantityDefaultValue(), 28, 600);
		...
		this.fmlBuffer[40] = new FmlField("SEPARATE_CRG_IND", FmlField.TYPE_BYTE, -1, null, 40, 600);
		this.fmlBuffer[41] = new FmlField("PRMT_ROWID", FmlField.TYPE_STRING, 19, null, 41, 600);
		this.fmlBuffer[42] = new FmlField("PT_DURATION", FmlField.TYPE_SHORT, -1, null, 42, 600);
		this.fmlBuffer[43] = new FmlField("DURATION_IND", FmlField.TYPE_BYTE, -1, null, 43, 600);
		this.fmlBuffer[44] = new FmlField("PP_IND", FmlField.TYPE_BYTE, -1, null, 44, 600);
		this.fmlBuffer[45] = new FmlField("AUTO_RENEWAL_IND", FmlField.TYPE_BYTE, -1, null, 45, 600);
		this.fmlBuffer[46] = new FmlField("CUT_DATE", FmlField.TYPE_STRING, 9, null, 46, 600);
		this.fmlBuffer[47] = new FmlField("TRS_ROWID", FmlField.TYPE_STRING, 19, null, 47, 600);
		this.fmlBuffer[48] = new FmlField("TRS_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 48, 600);
		this.fmlBuffer[49] = new FmlField("TRS_SOC", FmlField.TYPE_STRING, 10, null, 49, 600);
		this.fmlBuffer[50] = new FmlField("CALL_TYPE_CODE", FmlField.TYPE_BYTE, -1, null, 50, 600);
		this.fmlBuffer[51] = new FmlField("TOLL_RS_DESC", FmlField.TYPE_STRING, 31, null, 51, 600);
		this.fmlBuffer[52] = new FmlField("SUBLN_ROWID", FmlField.TYPE_STRING, 19, null, 52, 600);
		this.fmlBuffer[53] = new FmlField("FULL_AMT", FmlField.TYPE_DOUBLE, -1, null, 53, 600);
		this.fmlBuffer[54] = new FmlField("FIRST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 54, 600);
		this.fmlBuffer[55] = new FmlField("OTHER_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 55, 600);
		this.fmlBuffer[56] = new FmlField("LAST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 56, 600);
		this.fmlBuffer[57] = new FmlField("NO_OF_INSTALLMENTS", FmlField.TYPE_SHORT, -1, null, 57, 600);
		this.fmlBuffer[58] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 58, 600);
	} // End of constractor
	...
	public String get_SEPARATE_CRG_IND(int nIndex) throws FMLManipulationException { return (TypeConverter.byteToString((Byte) this.fmlBuffer[40].getValue(nIndex))); }
	public void set_SEPARATE_CRG_IND(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[40].setValue(nIndex, TypeConverter.stringToByte(value)); }
	public int get_SEPARATE_CRG_IND_size() throws FMLManipulationException { return (this.fmlBuffer[40].getCount()); }


	public String get_PRMT_ROWID(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[41].getValue(nIndex)); }
	public void set_PRMT_ROWID(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[41].setValue(nIndex, value); }
	public int get_PRMT_ROWID_size() throws FMLManipulationException { return (this.fmlBuffer[41].getCount()); }


	public Integer get_PT_DURATION(int nIndex) throws FMLManipulationException { return (TypeConverter.shortToInteger((Short) this.fmlBuffer[42].getValue(nIndex))); }
	public void set_PT_DURATION(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[42].setValue(nIndex, TypeConverter.integerToShort(value)); }
	public int get_PT_DURATION_size() throws FMLManipulationException { return (this.fmlBuffer[42].getCount()); }


	public String get_DURATION_IND(int nIndex) throws FMLManipulationException { return (TypeConverter.byteToString((Byte) this.fmlBuffer[43].getValue(nIndex))); }
	public void set_DURATION_IND(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[43].setValue(nIndex, TypeConverter.stringToByte(value)); }
	public int get_DURATION_IND_size() throws FMLManipulationException { return (this.fmlBuffer[43].getCount()); }


	public String get_PP_IND(int nIndex) throws FMLManipulationException { return (TypeConverter.byteToString((Byte) this.fmlBuffer[44].getValue(nIndex))); }
	public void set_PP_IND(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[44].setValue(nIndex, TypeConverter.stringToByte(value)); }
	public int get_PP_IND_size() throws FMLManipulationException { return (this.fmlBuffer[44].getCount()); }


	public String get_AUTO_RENEWAL_IND(int nIndex) throws FMLManipulationException { return (TypeConverter.byteToString((Byte) this.fmlBuffer[45].getValue(nIndex))); }
	public void set_AUTO_RENEWAL_IND(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[45].setValue(nIndex, TypeConverter.stringToByte(value)); }
	public int get_AUTO_RENEWAL_IND_size() throws FMLManipulationException { return (this.fmlBuffer[45].getCount()); }


	public String get_CUT_DATE(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[46].getValue(nIndex)); }
	public void set_CUT_DATE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[46].setValue(nIndex, value); }
	public int get_CUT_DATE_size() throws FMLManipulationException { return (this.fmlBuffer[46].getCount()); }


	public String get_TRS_ROWID(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[47].getValue(nIndex)); }
	public void set_TRS_ROWID(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[47].setValue(nIndex, value); }
	public int get_TRS_ROWID_size() throws FMLManipulationException { return (this.fmlBuffer[47].getCount()); }


	public String get_TRS_EXPIRATION_DATE(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[48].getValue(nIndex)); }
	public void set_TRS_EXPIRATION_DATE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[48].setValue(nIndex, value); }
	public int get_TRS_EXPIRATION_DATE_size() throws FMLManipulationException { return (this.fmlBuffer[48].getCount()); }


	public String get_TRS_SOC(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[49].getValue(nIndex)); }
	public void set_TRS_SOC(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[49].setValue(nIndex, value); }
	public int get_TRS_SOC_size() throws FMLManipulationException { return (this.fmlBuffer[49].getCount()); }


	public String get_CALL_TYPE_CODE(int nIndex) throws FMLManipulationException { return (TypeConverter.byteToString((Byte) this.fmlBuffer[50].getValue(nIndex))); }
	public void set_CALL_TYPE_CODE(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[50].setValue(nIndex, TypeConverter.stringToByte(value)); }
	public int get_CALL_TYPE_CODE_size() throws FMLManipulationException { return (this.fmlBuffer[50].getCount()); }


	public String get_TOLL_RS_DESC(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[51].getValue(nIndex)); }
	public void set_TOLL_RS_DESC(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[51].setValue(nIndex, value); }
	public int get_TOLL_RS_DESC_size() throws FMLManipulationException { return (this.fmlBuffer[51].getCount()); }


	public String get_SUBLN_ROWID(int nIndex) throws FMLManipulationException { return ((String) this.fmlBuffer[52].getValue(nIndex)); }
	public void set_SUBLN_ROWID(int nIndex, String value) throws FMLManipulationException { this.fmlBuffer[52].setValue(nIndex, value); }
	public int get_SUBLN_ROWID_size() throws FMLManipulationException { return (this.fmlBuffer[52].getCount()); }


	public Double get_FULL_AMT(int nIndex) throws FMLManipulationException { return ((Double) this.fmlBuffer[53].getValue(nIndex)); }
	public void set_FULL_AMT(int nIndex, Double value) throws FMLManipulationException { this.fmlBuffer[53].setValue(nIndex, value); }
	public int get_FULL_AMT_size() throws FMLManipulationException { return (this.fmlBuffer[53].getCount()); }


	public Double get_FIRST_INSTALL_RATE(int nIndex) throws FMLManipulationException { return ((Double) this.fmlBuffer[54].getValue(nIndex)); }
	public void set_FIRST_INSTALL_RATE(int nIndex, Double value) throws FMLManipulationException { this.fmlBuffer[54].setValue(nIndex, value); }
	public int get_FIRST_INSTALL_RATE_size() throws FMLManipulationException { return (this.fmlBuffer[54].getCount()); }


	public Double get_OTHER_INSTALL_RATE(int nIndex) throws FMLManipulationException { return ((Double) this.fmlBuffer[55].getValue(nIndex)); }
	public void set_OTHER_INSTALL_RATE(int nIndex, Double value) throws FMLManipulationException { this.fmlBuffer[55].setValue(nIndex, value); }
	public int get_OTHER_INSTALL_RATE_size() throws FMLManipulationException { return (this.fmlBuffer[55].getCount()); }


	public Double get_LAST_INSTALL_RATE(int nIndex) throws FMLManipulationException { return ((Double) this.fmlBuffer[56].getValue(nIndex)); }
	public void set_LAST_INSTALL_RATE(int nIndex, Double value) throws FMLManipulationException { this.fmlBuffer[56].setValue(nIndex, value); }
	public int get_LAST_INSTALL_RATE_size() throws FMLManipulationException { return (this.fmlBuffer[56].getCount()); }


	public Integer get_NO_OF_INSTALLMENTS(int nIndex) throws FMLManipulationException { return (TypeConverter.shortToInteger((Short) this.fmlBuffer[57].getValue(nIndex))); }
	public void set_NO_OF_INSTALLMENTS(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[57].setValue(nIndex, TypeConverter.integerToShort(value)); }
	public int get_NO_OF_INSTALLMENTS_size() throws FMLManipulationException { return (this.fmlBuffer[57].getCount()); }


	public Integer get_SUBSCRIBER_ID(int nIndex) throws FMLManipulationException { return ((Integer) this.fmlBuffer[58].getValue(nIndex)); }
	public void set_SUBSCRIBER_ID(int nIndex, Integer value) throws FMLManipulationException { this.fmlBuffer[58].setValue(nIndex, value); }
	public int get_SUBSCRIBER_ID_size() throws FMLManipulationException { return (this.fmlBuffer[58].getCount()); }
