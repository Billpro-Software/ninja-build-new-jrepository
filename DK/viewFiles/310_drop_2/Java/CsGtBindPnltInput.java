...
public class CsGtBindPnltInput extends ServiceInput {
	...
	public CsGtBindPnltInput() throws EnvironmentException, FMLManipulationException {
		...
		this.fmlBuffer[16] = new FmlField("ACTIVITYDATE", FmlField.TYPE_STRING, 9, null, 16, 1);
		...
		this.fmlBuffer[21] = new FmlField("SOC", FmlField.TYPE_STRING, 10, null, 21, 100);
		this.fmlBuffer[22] = new FmlField("SOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 22, 100);
		this.fmlBuffer[23] = new FmlField("SOC_VER_NO", FmlField.TYPE_INTEGER, -1, null, 23, 100);
		this.fmlBuffer[24] = new FmlField("CAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 24, 100);
		this.fmlBuffer[25] = new FmlField("CAMPAIGN", FmlField.TYPE_STRING, 10, null, 25, 100);
		this.fmlBuffer[26] = new FmlField("COMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 26, 100);
		this.fmlBuffer[27] = new FmlField("SOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 27, 100);
		this.fmlBuffer[28] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 28, 100);
		this.fmlBuffer[29] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 29, 100);
		this.fmlBuffer[30] = new FmlField("SERVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 30, 100);
		this.fmlBuffer[31] = new FmlField("EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 31, 100);
		this.fmlBuffer[32] = new FmlField("SOC_LEVEL_CODE", FmlField.TYPE_BYTE, -1, null, 32, 100);
		this.fmlBuffer[33] = new FmlField("DEALER_CODE", FmlField.TYPE_STRING, 6, null, 33, 100);
		this.fmlBuffer[34] = new FmlField("SALES_AGENT", FmlField.TYPE_STRING, 6, null, 34, 100);
		this.fmlBuffer[35] = new FmlField("EFFECTIVE_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 35, 100);
		this.fmlBuffer[36] = new FmlField("EXPIRATION_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 36, 100);
		this.fmlBuffer[37] = new FmlField("TRX_ID", FmlField.TYPE_INTEGER, -1, null, 37, 100);
		this.fmlBuffer[38] = new FmlField("INS_TRX_ID", FmlField.TYPE_INTEGER, -1, null, 38, 100);
		this.fmlBuffer[39] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 39, 100);
		this.fmlBuffer[40] = new FmlField("LOAN_VER_NO", FmlField.TYPE_INTEGER, -1, null, 40, 100);
		this.fmlBuffer[41] = new FmlField("LOAN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 41, 100);
		this.fmlBuffer[42] = new FmlField("SOC_START_RC_DATE", FmlField.TYPE_STRING, 9, null, 42, 100);
		this.fmlBuffer[43] = new FmlField("SOC_QUANTITY", FmlField.TYPE_SHORT, -1, SystemDefaultsReferenceTable.getSocQuantityDefaultValue(), 43, 100);
		this.fmlBuffer[44] = new FmlField("BILL_TEXT", FmlField.TYPE_STRING, 41, null, 44, 100);
		this.fmlBuffer[45] = new FmlField("SOC_ROWID", FmlField.TYPE_STRING, 19, null, 45, 100);
		this.fmlBuffer[46] = new FmlField("SALE_EFF_DATE", FmlField.TYPE_STRING, 9, null, 46, 100);
		this.fmlBuffer[47] = new FmlField("SALE_EXP_DATE", FmlField.TYPE_STRING, 9, null, 47, 100);
		this.fmlBuffer[48] = new FmlField("MINIMUM_NO_MONTHS", FmlField.TYPE_SHORT, -1, null, 48, 100);
		this.fmlBuffer[49] = new FmlField("SOC_DESCRIPTION", FmlField.TYPE_STRING, 31, null, 49, 100);
		this.fmlBuffer[50] = new FmlField("MAX_QUANTITY", FmlField.TYPE_SHORT, -1, null, 50, 100);
		this.fmlBuffer[51] = new FmlField("ALLOW_FREE_BILL_TXT", FmlField.TYPE_BYTE, -1, null, 51, 100);
		this.fmlBuffer[52] = new FmlField("FLEXIBLE_LOAN_IND", FmlField.TYPE_BYTE, -1, null, 52, 100);
		this.fmlBuffer[53] = new FmlField("EXTERNAL_PARTY", FmlField.TYPE_STRING, 3, null, 53, 100);
		this.fmlBuffer[54] = new FmlField("SEPARATE_CRG_IND", FmlField.TYPE_BYTE, -1, null, 54, 100);
		this.fmlBuffer[55] = new FmlField("PRMT_ROWID", FmlField.TYPE_STRING, 19, null, 55, 100);
		this.fmlBuffer[56] = new FmlField("PT_DURATION", FmlField.TYPE_SHORT, -1, null, 56, 100);
		this.fmlBuffer[57] = new FmlField("DURATION_IND", FmlField.TYPE_BYTE, -1, null, 57, 100);
		this.fmlBuffer[58] = new FmlField("PP_IND", FmlField.TYPE_BYTE, -1, null, 58, 100);
		this.fmlBuffer[59] = new FmlField("AUTO_RENEWAL_IND", FmlField.TYPE_BYTE, -1, null, 59, 100);
		this.fmlBuffer[60] = new FmlField("CUT_DATE", FmlField.TYPE_STRING, 9, null, 60, 100);
		this.fmlBuffer[61] = new FmlField("TRS_ROWID", FmlField.TYPE_STRING, 19, null, 61, 100);
		this.fmlBuffer[62] = new FmlField("TRS_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 62, 100);
		this.fmlBuffer[63] = new FmlField("TRS_SOC", FmlField.TYPE_STRING, 10, null, 63, 100);
		this.fmlBuffer[64] = new FmlField("CALL_TYPE_CODE", FmlField.TYPE_BYTE, -1, null, 64, 100);
		this.fmlBuffer[65] = new FmlField("TOLL_RS_DESC", FmlField.TYPE_STRING, 31, null, 65, 100);
		this.fmlBuffer[66] = new FmlField("SUBLN_ROWID", FmlField.TYPE_STRING, 19, null, 66, 100);
		this.fmlBuffer[67] = new FmlField("FULL_AMT", FmlField.TYPE_DOUBLE, -1, null, 67, 100);
		this.fmlBuffer[68] = new FmlField("FIRST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 68, 100);
		this.fmlBuffer[69] = new FmlField("OTHER_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 69, 100);
		this.fmlBuffer[70] = new FmlField("LAST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 70, 100);
		this.fmlBuffer[71] = new FmlField("NO_OF_INSTALLMENTS", FmlField.TYPE_SHORT, -1, null, 71, 100);
		this.fmlBuffer[72] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 72, 100);
	} // End of constractor
